...
module.exports.addsong = (req, res, next) => {
    ...
    song.title = req.body.title.replace(/</g,'&lt;').replace(/>/g,'&gt;');
    song.artist = req.body.artist.replace(/</g,'&lt;').replace(/>/g,'&gt;');
    song.album = req.body.album.replace(/</g,'&lt;').replace(/>/g,'&gt;');
    song.year = req.body.year;
    song.comment = req.body.comment.replace(/</g,'&lt;').replace(/>/g,'&gt;');
    song.reserve = req.body.reserve;
    song.track = req.body.track;
    song.genre = req.body.genre.replace(/</g,'&lt;').replace(/>/g,'&gt;');
    song.review = req.body.review.replace(/</g,'&lt;').replace(/>/g,'&gt;');
